...
\geometry{left=1.4cm,right=1.4cm,top=0.7cm,bottom=0.7cm}
...
% Круглая фотография
\newcommand{\roundpic}[2][1.4cm]{% #1 — радиус, #2 — путь к файлу
  \pgfmathsetlengthmacro{\picsize}{2*#1}% диаметр = 2 * радиус
  \begin{tikzpicture}
    \clip (0,0) circle (#1);
    \node at (0,0) {\includegraphics[width=\picsize]{#2}};
  \end{tikzpicture}%
}
...
\titlespacing{\section}{0pt}{0.45em}{0.35em} % расстояние до и после заголовка секции
\setlength{\parskip}{0.45em}                 % между абзацами
...
\begin{minipage}[c]{0.23\textwidth}
    \centering
    \roundpic[1.9cm]{pic/img.png}
\end{minipage}
\hfill
\begin{minipage}[c]{0.73\textwidth}
    {\Huge \bfseries Мурадян Денис Степанович}\\[0.5em]
    {\Large \bfseries Machine Learning Engineer}\\[0.5em]
    ...
    \faHome~ \href{https://yandex.ru/maps/-/CHRjvNpm}{Санкт-Петербург, Россия}\\[0.15em]
    \faTelegram~ \href{https://t.me/DenisMuradyan}{Telegram (@DenisMuradyan)} \hspace{0.3em}
    \faGithub~ \href{https://github.com/Denigmma}{GitHub (Denigmma)}
\end{minipage}
...
\begin{itemize}
    ...
    \item \textbf{\href{https://studolymp.gazprom.ru/}{«Газпром»}}, трек «Информационные системы и технологии» - \textbf{призер} 2024-2025 \href{https://github.com/Denigmma/Practice_LogBook/blob/main/Gazprom/2024-25/Диплом%20Мурадян%20Денис%20Степанович%20по%20профилю%20_Информационные%20системы%20и%20технологии_.pdf}{certificate}
\end{itemize}
...
\item \textbf{Автоматизированная система парсинга данных на основе LLM --- ПАО "Сбербанк России"} \href{https://github.com/Denigmma/Automated_LLM_data_parsing_system}{GitHub Automated LLM data parsing system}\\
