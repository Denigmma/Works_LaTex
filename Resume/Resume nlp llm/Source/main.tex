...
%Рекомендательная система новостей в Telegram: сбор контента из публичных каналов, онбординг через LLM-агента из свободного текста, кандидаты на эмбеддингах в Chroma (user→item, item→item, слабый user→user) + rerank Logistic MF по лайкам/дизлайкам и MMR-диверсификация.
